...
<html>
    ...
    <div>
        <%
            ...
            if (titlu != null) {
                jb.connect();
                jb.adaugaFilm(titlu, java.lang.Integer.parseInt(an_aparitie), regizor, java.lang.Integer.parseInt(durata_minute), 
                		java.lang.Float.parseFloat(nota_imdb));
                jb.disconnect();
        %>
        ...
        <br/>
        <br/>
        <h2 align="center">Filmul a fost adaugat !</h2><%
        } else {
        %>
        <h1 align="center">Adauga film:</h1>
        <br/>
        <form action="adauga_Film.jsp" method="post" >
            <table align="center">
                <tr>
                    <td align="right">Titlu:</td>
                    <td> <input type="text" name="titlu" size="40" required="required" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="regizor" size="30" required="required"/></td>
                </tr>
                <tr>
                    <td align="right">Durata minute:</td>
                    <td> <input type="number" min="10" max="420" name="durata_minute" size="30" required="required"/></td>
                </tr>
                <tr>
                    <td align="right">Nota IMDb:</td>
                    <td> <input type="number" step="0.01" name="nota_imdb" min="1.0" max="10.0" required="required"/></td>
                </tr>
            </table>
